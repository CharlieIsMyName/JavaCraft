...
class GamePanel extends JPanel implements MouseMotionListener, MouseListener, KeyListener{
	...
	public void addBase2(Player p, Player neutral){
		...
		p.addNewUnit("scv", new Point(120, 122), new Point(118,126));
		p.addNewUnit("scv", new Point(123, 122),new Point(124,126));
		p.addNewUnit("scv", new Point(121, 122), new Point(126,126));
	}
	...
	public void addBase3(Player p, Player neutral){
		...
		p.addNewUnit("scv", new Point(29, 105), new Point(12,126));
