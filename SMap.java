...
public class SMap{
	...
	public LinkedList<Point> findPath(ArrayList<Integer> walkable, int x1, int y1, int x2, int y2){
		...
		/****************************************************
		//Finds a path using A* between 2 points on a grid and returns a linked list of Point with first element
		//in the list as the starting point and last element as destination. If no path exists returns
		//a path to the closest grid element
	
		//Parameters should be grid coordinates, not coordinates on the screen.
